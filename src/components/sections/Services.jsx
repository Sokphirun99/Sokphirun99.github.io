...
export function Services() {
  ...
  return (
    <section id="services" className="py-20 md:py-24 lg:py-32 bg-transparent">
          ...
          {services.map((srv, idx) => {
            ...
            return (
              <Reveal key={srv.id} delay={idx * 100} className="relative group flex">
                ...
                <div className="p-6 sm:p-8 xl:p-10 flex flex-col items-center text-center w-full hover:scale-[1.02] transition-transform duration-500">
                  ...
                  <h4 className="text-[18px] sm:text-[20px] font-bold tracking-tight mb-3 text-white">
                    {srv.title}
                  </h4>
                  <p className="text-[14px] sm:text-[15px] text-white/70 leading-relaxed font-normal">
                    {srv.description}
                  </p>
                </div>
              </Reveal>
